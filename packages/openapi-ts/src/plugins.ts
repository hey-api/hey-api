...
export const clientEffect = pluginHelper('@hey-api/client-effect');
...
export const effect = pluginHelper('@hey-api/effect');
...
export const effectSchema = pluginHelper('effect-schema');
