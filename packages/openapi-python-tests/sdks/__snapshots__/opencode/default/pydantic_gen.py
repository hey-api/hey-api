...
class AuthRemoveError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError]]):
    """BadRequest | InvalidRequestError"""

    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError] = Field(..., description="BadRequest | InvalidRequestError")
...
class AuthSetError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError]]):
    """BadRequest | InvalidRequestError"""
...
class AppLogError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError]]):
    """BadRequest | InvalidRequestError"""
...
GlobalHealthError: TypeAlias = BadRequestError
...
GlobalEventError: TypeAlias = BadRequestError
...
GlobalConfigGetError: TypeAlias = BadRequestError
...
class GlobalConfigUpdateError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError]]):
    """BadRequest | InvalidRequestError"""
...
GlobalDisposeError: TypeAlias = BadRequestError
...
class GlobalUpgradeError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError]]):
    """BadRequest | InvalidRequestError"""
...
ConfigGetError: TypeAlias = BadRequestError
...
class ConfigUpdateError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError]]):
    """BadRequest | InvalidRequestError"""
...
ConfigProvidersError: TypeAlias = BadRequestError
...
class ExperimentalConsoleGetError(RootModel[Union[BadRequestError, EffectHttpApiErrorInternalServerError]]):
    root: Union[BadRequestError, EffectHttpApiErrorInternalServerError]
...
class ExperimentalConsoleListOrgsError(RootModel[Union[BadRequestError, EffectHttpApiErrorInternalServerError]]):
    root: Union[BadRequestError, EffectHttpApiErrorInternalServerError]
...
class ToolListError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError]]):
    """BadRequest | InvalidRequestError"""
...
class ToolIdsError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError]]):
    """BadRequest | InvalidRequestError"""
...
class WorktreeRemoveError(RootModel[Union[WorktreeError, InvalidRequestError]]):
    """WorktreeError | InvalidRequestError"""

    root: Union[WorktreeError, InvalidRequestError] = Field(..., description="WorktreeError | InvalidRequestError")
...
class WorktreeListError(RootModel[Union[WorktreeError, InvalidRequestError]]):
    """WorktreeError | InvalidRequestError"""
...
class WorktreeCreateError(RootModel[Union[WorktreeError, InvalidRequestError]]):
    """WorktreeError | InvalidRequestError"""
...
class WorktreeResetError(RootModel[Union[WorktreeError, InvalidRequestError]]):
    """WorktreeError | InvalidRequestError"""
...
ExperimentalSessionListError: TypeAlias = BadRequestError
...
ExperimentalResourceListError: TypeAlias = BadRequestError
...
FindTextError: TypeAlias = BadRequestError
...
FindFilesError: TypeAlias = BadRequestError
...
FindSymbolsError: TypeAlias = BadRequestError
...
FileListError: TypeAlias = BadRequestError
...
FileReadError: TypeAlias = BadRequestError
...
FileStatusError: TypeAlias = BadRequestError
...
InstanceDisposeError: TypeAlias = BadRequestError
...
PathGetError: TypeAlias = BadRequestError
...
VcsGetError: TypeAlias = BadRequestError
...
VcsStatusError: TypeAlias = BadRequestError
...
VcsDiffError: TypeAlias = BadRequestError
...
VcsDiffRawError: TypeAlias = BadRequestError
...
class VcsApplyError_(RootModel[Union[VcsApplyError, InvalidRequestError]]):
    """VcsApplyError | InvalidRequestError"""

    root: Union[VcsApplyError, InvalidRequestError] = Field(..., description="VcsApplyError | InvalidRequestError")
...
CommandListError: TypeAlias = BadRequestError
...
AppAgentsError: TypeAlias = BadRequestError
...
AppSkillsError: TypeAlias = BadRequestError
...
LspStatusError: TypeAlias = BadRequestError
...
FormatterStatusError: TypeAlias = BadRequestError
...
McpStatusError: TypeAlias = BadRequestError
...
class McpAddError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError]]):
    """BadRequest | InvalidRequestError"""
...
class McpAuthRemoveError(RootModel[Union[BadRequestError, McpServerNotFoundError]]):
    root: Union[BadRequestError, McpServerNotFoundError]
...
class McpAuthStartError(RootModel[Union[McpUnsupportedOAuthError, InvalidRequestError, McpServerNotFoundError]]):
    root: Union[McpUnsupportedOAuthError, InvalidRequestError, McpServerNotFoundError]
...
class McpAuthCallbackError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, McpServerNotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, McpServerNotFoundError]
...
class McpAuthAuthenticateError(RootModel[Union[McpUnsupportedOAuthError, InvalidRequestError, McpServerNotFoundError]]):
    root: Union[McpUnsupportedOAuthError, InvalidRequestError, McpServerNotFoundError]
...
class McpConnectError(RootModel[Union[BadRequestError, McpServerNotFoundError]]):
    root: Union[BadRequestError, McpServerNotFoundError]
...
class McpDisconnectError(RootModel[Union[BadRequestError, McpServerNotFoundError]]):
    root: Union[BadRequestError, McpServerNotFoundError]
...
ProjectListError: TypeAlias = BadRequestError
...
ProjectCurrentError: TypeAlias = BadRequestError
...
ProjectInitGitError: TypeAlias = BadRequestError
...
class ProjectUpdateError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, ProjectNotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, ProjectNotFoundError]
...
PtyShellsError: TypeAlias = BadRequestError
...
PtyListError: TypeAlias = BadRequestError
...
class PtyCreateError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError]]):
    """BadRequest | InvalidRequestError"""
...
class PtyRemoveError(RootModel[Union[BadRequestError, PtyNotFoundError]]):
    root: Union[BadRequestError, PtyNotFoundError]
...
class PtyGetError(RootModel[Union[BadRequestError, PtyNotFoundError]]):
    root: Union[BadRequestError, PtyNotFoundError]
...
class PtyUpdateError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, PtyNotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, PtyNotFoundError]
...
class PtyConnectTokenError(RootModel[Union[BadRequestError, PtyForbiddenError, PtyNotFoundError]]):
    root: Union[BadRequestError, PtyForbiddenError, PtyNotFoundError]
...
QuestionListError: TypeAlias = BadRequestError
...
class QuestionReplyError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, QuestionNotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, QuestionNotFoundError]
...
class QuestionRejectError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, QuestionNotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, QuestionNotFoundError]
...
PermissionListError: TypeAlias = BadRequestError
...
class PermissionReplyError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, PermissionNotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, PermissionNotFoundError]
...
ProviderListError: TypeAlias = BadRequestError
...
ProviderAuthError_: TypeAlias = BadRequestError
...
class ProviderOauthAuthorizeError(RootModel[Union[ProviderAuthError1, InvalidRequestError]]):
    """ProviderAuthError | InvalidRequestError"""

    root: Union[ProviderAuthError1, InvalidRequestError] = Field(..., description="ProviderAuthError | InvalidRequestError")
...
class ProviderOauthCallbackError(RootModel[Union[ProviderAuthError1, InvalidRequestError]]):
    """ProviderAuthError | InvalidRequestError"""
...
SessionListError: TypeAlias = BadRequestError
...
class SessionCreateError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError]]):
    """BadRequest | InvalidRequestError"""
...
class SessionStatusError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError]]):
    """BadRequest | InvalidRequestError"""
...
class SessionDeleteError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]
...
class SessionGetError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]
...
class SessionUpdateError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]
...
class SessionChildrenError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]
...
class SessionTodoError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]
...
SessionDiffError: TypeAlias = BadRequestError
...
class SessionMessagesError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]
...
class SessionPromptError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]
...
class SessionDeleteMessageError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError, SessionBusyError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError, SessionBusyError]
...
class SessionMessageError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]
...
class SessionForkError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]
...
class SessionAbortError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError]]):
    """BadRequest | InvalidRequestError"""
...
class SessionInitError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]
...
class SessionUnshareError(RootModel[Union[BadRequestError, NotFoundError, EffectHttpApiErrorInternalServerError]]):
    root: Union[BadRequestError, NotFoundError, EffectHttpApiErrorInternalServerError]
...
class SessionShareError(RootModel[Union[BadRequestError, NotFoundError, EffectHttpApiErrorInternalServerError]]):
    root: Union[BadRequestError, NotFoundError, EffectHttpApiErrorInternalServerError]
...
class SessionSummarizeError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]
...
class SessionPromptAsyncError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]
...
class SessionCommandError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]
...
class SessionShellError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError, SessionBusyError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError, SessionBusyError]
...
class SessionRevertError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError, SessionBusyError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError, SessionBusyError]
...
class SessionUnrevertError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError, SessionBusyError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError, SessionBusyError]
...
class PermissionRespondError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError, PermissionNotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError, PermissionNotFoundError]
...
class PartDeleteError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]
...
class PartUpdateError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]
...
SyncStartError: TypeAlias = BadRequestError
...
class SyncReplayError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError]]):
    """BadRequest | InvalidRequestError"""
...
class SyncStealError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError]]):
    """BadRequest | InvalidRequestError"""
...
class SyncHistoryListError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError]]):
    """BadRequest | InvalidRequestError"""
...
class V2SessionListError(RootModel[Union[InvalidCursorError, InvalidRequestError, UnauthorizedError]]):
    root: Union[InvalidCursorError, InvalidRequestError, UnauthorizedError]
...
class V2SessionPromptError(RootModel[Union[InvalidRequestError, UnauthorizedError, SessionNotFoundError, ServiceUnavailableError]]):
    root: Union[InvalidRequestError, UnauthorizedError, SessionNotFoundError, ServiceUnavailableError]
...
class V2SessionCompactError(RootModel[Union[InvalidRequestError, UnauthorizedError, SessionNotFoundError, ServiceUnavailableError]]):
    root: Union[InvalidRequestError, UnauthorizedError, SessionNotFoundError, ServiceUnavailableError]
...
class V2SessionWaitError(RootModel[Union[InvalidRequestError, UnauthorizedError, SessionNotFoundError, ServiceUnavailableError]]):
    root: Union[InvalidRequestError, UnauthorizedError, SessionNotFoundError, ServiceUnavailableError]
...
class V2SessionContextError(RootModel[Union[InvalidRequestError, UnauthorizedError, SessionNotFoundError, UnknownError1]]):
    root: Union[InvalidRequestError, UnauthorizedError, SessionNotFoundError, UnknownError1]
...
class V2SessionMessagesError(RootModel[Union[InvalidCursorError, InvalidRequestError, UnauthorizedError, SessionNotFoundError, UnknownError1]]):
    root: Union[InvalidCursorError, InvalidRequestError, UnauthorizedError, SessionNotFoundError, UnknownError1]
...
class V2ModelListError(RootModel[Union[InvalidRequestError, UnauthorizedError, ServiceUnavailableError]]):
    root: Union[InvalidRequestError, UnauthorizedError, ServiceUnavailableError]
...
class V2ProviderListError(RootModel[Union[InvalidRequestError, UnauthorizedError, ServiceUnavailableError]]):
    root: Union[InvalidRequestError, UnauthorizedError, ServiceUnavailableError]
...
class V2ProviderGetError(RootModel[Union[InvalidRequestError, UnauthorizedError, ProviderNotFoundError, ServiceUnavailableError]]):
    root: Union[InvalidRequestError, UnauthorizedError, ProviderNotFoundError, ServiceUnavailableError]
...
class TuiAppendPromptError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError]]):
    """BadRequest | InvalidRequestError"""
...
TuiOpenHelpError: TypeAlias = BadRequestError
...
TuiOpenSessionsError: TypeAlias = BadRequestError
...
TuiOpenThemesError: TypeAlias = BadRequestError
...
TuiOpenModelsError: TypeAlias = BadRequestError
...
TuiSubmitPromptError: TypeAlias = BadRequestError
...
TuiClearPromptError: TypeAlias = BadRequestError
...
class TuiExecuteCommandError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError]]):
    """BadRequest | InvalidRequestError"""
...
TuiShowToastError: TypeAlias = BadRequestError
...
class TuiPublishError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError]]):
    """BadRequest | InvalidRequestError"""
...
class TuiSelectSessionError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]]):
    root: Union[EffectHttpApiErrorBadRequest, InvalidRequestError, NotFoundError]
...
TuiControlNextError: TypeAlias = BadRequestError
...
TuiControlResponseError: TypeAlias = BadRequestError
...
ExperimentalWorkspaceAdapterListError: TypeAlias = BadRequestError
...
ExperimentalWorkspaceListError: TypeAlias = BadRequestError
...
class ExperimentalWorkspaceCreateError(RootModel[Union[WorkspaceCreateError, EffectHttpApiErrorBadRequest, InvalidRequestError]]):
    """WorkspaceCreateError | BadRequest | InvalidRequestError"""

    root: Union[WorkspaceCreateError, EffectHttpApiErrorBadRequest, InvalidRequestError] = Field(..., description="WorkspaceCreateError | BadRequest | InvalidRequestError")
...
ExperimentalWorkspaceSyncListError: TypeAlias = BadRequestError
...
ExperimentalWorkspaceStatusError: TypeAlias = BadRequestError
...
class ExperimentalWorkspaceRemoveError(RootModel[Union[EffectHttpApiErrorBadRequest, InvalidRequestError]]):
    """BadRequest | InvalidRequestError"""
...
class ExperimentalWorkspaceWarpError(RootModel[Union[WorkspaceWarpError, VcsApplyError, InvalidRequestError, NotFoundError]]):
    root: Union[WorkspaceWarpError, VcsApplyError, InvalidRequestError, NotFoundError]
...
class PtyConnectError(RootModel[Union[EffectHttpApiErrorForbidden, NotFoundError]]):
    root: Union[EffectHttpApiErrorForbidden, NotFoundError]
