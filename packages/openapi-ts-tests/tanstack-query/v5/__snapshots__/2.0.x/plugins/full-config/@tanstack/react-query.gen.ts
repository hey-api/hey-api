...
import { type DefaultError, type QueryClient, queryOptions, useMutation, type UseMutationOptions, useQuery, useQueryClient, type UseQueryOptions } from '@tanstack/react-query';
...
export const useServiceWithEmptyTagQuery = (options?: Options<ServiceWithEmptyTagData>, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown, ReturnType<typeof serviceWithEmptyTagQueryKey>>, 'queryKey' | 'queryFn'>>) => useQuery({ ...serviceWithEmptyTagOptions(options), ...queryOptions });
...
export const useCallWithNoContentResponseQuery = (options?: Options<CallWithNoContentResponseData>, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown, ReturnType<typeof callWithNoContentResponseQueryKey>>, 'queryKey' | 'queryFn'>>) => useQuery({ ...callWithNoContentResponseOptions(options), ...queryOptions });
...
export const useDummyAQuery = (options?: Options<DummyAData>, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown, ReturnType<typeof dummyAQueryKey>>, 'queryKey' | 'queryFn'>>) => useQuery({ ...dummyAOptions(options), ...queryOptions });
...
export const useDummyBQuery = (options?: Options<DummyBData>, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown, ReturnType<typeof dummyBQueryKey>>, 'queryKey' | 'queryFn'>>) => useQuery({ ...dummyBOptions(options), ...queryOptions });
